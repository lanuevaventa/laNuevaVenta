...
// --- NUEVAS CONSULTAS MÉTRICAS ---

// Productos más vendidos (requiere tablas PedidoItem/Pedido)
$mas_vendidos = [];
...
// Usuarios más activos (pedidos + opiniones)
$usuarios_activos = [];
...
// Opiniones promedio por producto
$opiniones_promedio = [];
...
// Actividad reciente (admin / sistema)
$actividad = [];
...
// Helper: devolver ruta válida o un placeholder embebido si el archivo no existe
