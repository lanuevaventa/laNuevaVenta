...
// obtener productos de usuario (asumiendo que tienes una tabla Vende que relaciona usuarios con productos)
...
<head>
  ...
  <!-- Pegar aquí (exacto del index) los estilos/links del chatbot si el index los define en <head> -->
</head>
