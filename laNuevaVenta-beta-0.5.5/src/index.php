...
if ($es_busqueda) {
    ...
    $query = "SELECT * FROM Producto WHERE LOWER(titulo) LIKE LOWER($1) ORDER BY id_producto DESC";
    $result = pg_query_params($conexion, $query, ['%' . $busqueda . '%']);
} else {
    // sin búsqueda, mostrar últimos 9 productos
